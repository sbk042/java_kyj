...
insert into 테이블명(속성1, ..., 속성n)
	select 속성1, ..., 속성n form 테이블명 [where 조건]
    검색을 해서 내가 원하는 테이블에 있는 걸 [] 안에 넣어주고 싶을 때 사용
*/

-- 연습 1.) 과목코드가 MSC002이고, 과목명이 영어I, 학점이 2학점, 
--         일주일에 3시간 수업을 하는 과목을 추가하는 쿼리를 작성하시오.
