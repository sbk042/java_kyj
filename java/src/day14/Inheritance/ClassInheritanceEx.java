...
public class ClassInheritanceEx {
	...
	public static void main(String[] args) {
		...
		// 문법적으로 에러가 발생하지 않으면 예외가 발생 : 다운캐스팅이 안되는 경우이기 때문에
...
class Phone{
	...
	public void call(String num) {
		System.out.println(num); // 내가 전화를 거는 상대방의 번호
	...
	// public Phone(){} //생성자가 하나도 없으면 컴파일할 때 기본 생성자가 자동으로 추가된다.
}
