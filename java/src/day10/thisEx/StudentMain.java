...
public class StudentMain {
	...
	public static void main(String[] args) {
		...
		std1.print();
		//Student1.print(); //에러바생. static이 print에는 안붙어서
		std2.print();
...
class Student1{
	static static int studentCount;
	private int grade, classNum, number;
	private String name; //생성자 만들기 (우클릭>source>Generate constructor using field)
	//아래 생성자는 매개변수가 있고, 매개벼수의 이름이 멤버변수와 같기 때문에
	...
	public Student1() {
		...
		//int grade = 10;
		//this.grade = grade;
		this(1,1,1,""); // 다른 생성자 호출 시 첫 라인에 써야함
		name = "";
		/*
		grade = 1;
		classNum = 1;
		...
		*/
		...
		public void print() {
			...
			// 클래스 변수 사용 가능
			//System.out.println("cout   : " + studentCount);
			//클래스 메서드 사용 가능
			//printCount();
		}
		//클래스 메서드
		public static void printCount() {
			...
			System.out.println("Registered stduent count :" + studentCount);
		}
//	}
