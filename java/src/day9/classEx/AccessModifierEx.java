...
public class AccessModifierEx {
	...
	public static void main(String[] args) {
		...
		//public 같은 패키지이든 아니든 상관없으 사용 할 수 있다.
		// ctril + shift + o
		a.num3 = 10;
		b.num3 = 20;
...
class A{
	 ...
	 * 메서드명 : print
	 */
	public void print() {//static이 안 붙어 있기 때문에 매개변수가 빈칸
		//num1은 private이기 때문에 A클래스의 메서드에서 호출 될 수 있다.
		//지금 여기 class A에서만 출력이 가능(private이기 때문)
	...
	//private으로 된 num1에 값을 변경하기 위해서 setter를 추가 한다.
