...
public class MapEx {
	...
	public static void main(String[] args) {
		/* Map을 배열처럼 사용하는 에제 정수 배열/정수 리스트*/
		...
		map2.put("abc123", "abc"); //key값이 중복된 정보를 추가해봄
		map2.put("zxc", "abc");
		System.out.println(map2); 
		//key값은 중복 될 수 없기 때문에 맞막 value값이 덮어씌어짐
		...
		while(it.hasNext()) {
			...
			String pw = map2.get(id);//key값(id)을 이용해서 value값을 가져옴 
